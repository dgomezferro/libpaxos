...
*/
#define PROPOSER_PREEXEC_WIN_SIZE 4000
...
*/
#define PROPOSER_P2_CONCURRENCY 2000
...
/* 
    ...
    Unit is microseconds - i.e. 1500000 = 1.5 secs
*/
#define P2_TIMEOUT_INTERVAL 150000
...
*/
#define PROPOSER_ARRAY_SIZE 8192
...
/* 
  ...
  MUST be a power of 2
*/
#define LEARNER_ARRAY_SIZE 8192
