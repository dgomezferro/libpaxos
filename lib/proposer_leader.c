...
static void leader_open_instances_p2_expired();
static void leader_open_instances_p2_new();
...
leader_init() {
    ...
    inf_prepare_info.infinite_opened = 0;
    inf_prepare_info.promises_bitvector = 0;
    inf_prepare_info.promises_count = 0;
    inf_prepare_info.status = empty;
